...
<script type="text/babel">
  ...
  import scrollIntoView from 'exarcheia-element/src/utils/scroll-into-view';
  import { getValueByPath, valueEquals, isIE, isEdge } from 'exarcheia-element/src/utils/util';
