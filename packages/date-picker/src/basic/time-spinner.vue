...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'exarcheia-element/src/utils/date-util';
  import ElScrollbar from 'exarcheia-element/packages/scrollbar';
  import RepeatClick from 'exarcheia-element/src/directives/repeat-click';
