<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/DreamCraftSu/element@dev/element_logo.svg">
</p>

<p align="center">
  <a href="https://travis-ci.org/DreamCraftSu/element">
    <img src="https://travis-ci.org/DreamCraftSu/element.svg?branch=master">
  </a>
  <a href="https://coveralls.io/github/DreamCraftSu/element?branch=master">
...
- [Element for React](https://github.com/DreamCraftSu/element-react)
- [Element for Angular](https://github.com/DreamCraftSu/element-angular)
- [Atom helper](https://github.com/DreamCraftSu/element-helper)
...
- Gitter
  ...
  - [Chinese users](https://gitter.im/DreamCraftSu/element)
...
For those who are interested in contributing to Element, please refer to our contributing guide ([中文](https://github.com/DreamCraftSu/element/blob/master/.github/CONTRIBUTING.zh-CN.md) | [English](https://github.com/DreamCraftSu/element/blob/master/.github/CONTRIBUTING.en-US.md) | [Español](https://github.com/DreamCraftSu/element/blob/master/.github/CONTRIBUTING.es.md) | [Français](https://github.com/DreamCraftSu/element/blob/master/.github/CONTRIBUTING.fr-FR.md)) to see how to run this project.

## Changelog
Detailed changes for each release are documented in the [release notes](https://github.com/DreamCraftSu/element/releases).

## FAQ
We have collected some [frequently asked questions](https://github.com/DreamCraftSu/element/blob/master/FAQ.md). Before reporting an issue, please search if the FAQ has the answer to your problem.

## Contribution
Please make sure to read the contributing guide ([中文](https://github.com/DreamCraftSu/element/blob/master/.github/CONTRIBUTING.zh-CN.md) | [English](https://github.com/DreamCraftSu/element/blob/master/.github/CONTRIBUTING.en-US.md) | [Español](https://github.com/DreamCraftSu/element/blob/master/.github/CONTRIBUTING.es.md) | [Français](https://github.com/DreamCraftSu/element/blob/master/.github/CONTRIBUTING.fr-FR.md)) before making a pull request.
